...
import Assets2 from "../../../assets/img/assets2.png"
    ...
    return (
        <div>
                ...
                <div className="flex flex-col mt-5 mb-10">
                    ...
                    <div className="grid grid-cols-2 mt-16 gap-y-5 gap-x-2">
                        <div className="flex space-x-3">
                            <div><LazyLoadImage src={Icon1} alt="logo"></LazyLoadImage></div>
            ...
            <div className="flex justify-end">
                <LazyLoadImage src={Assets1} className="" alt="logo">
                </LazyLoadImage>
            </div>
            <div className="">
                <LazyLoadImage src={Assets2} className="pb-8" alt="logo">
                </LazyLoadImage>
            </div>
        </div>
    );
